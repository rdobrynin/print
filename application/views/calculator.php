  ...
  <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
      <ul class="nav navbar-nav side-nav">
        ...
        <li class="active"><a href="calculator"><i class="fa fa-font"></i> Calculator</a></li>
        <li><a href="#"><i class="fa fa-desktop"></i> Projects</a></li>
        <li><a href="#"><i class="fa fa-wrench"></i> Tasks</a></li>
        <li><a href="#"><i class="fa fa-wrench"></i> Settings</a></li>
        <li><a href="#"><i class="fa fa-file"></i> Workflow charts</a></li>
        <li><a href="#"><i class="fa fa-file"></i> Events</a></li>
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-caret-square-o-down"></i> Management<b class="caret"></b></a>
