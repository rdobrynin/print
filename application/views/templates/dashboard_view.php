<!-- Page content -->
    ...
    <div class="row">
        <div class="col-md-8">asas</div>
        <div class="col-md-4">
            <p class="lead">Last comment</p>
            <div class="[ panel panel-default ] panel-google-plus">
                ...
                <div class="panel-google-plus-comment">
                    <img class="img-circle" src="<?php base_url();?>uploads/avatar/bg_man@2x.jpg" width="40" height="40" alt="User Image" />
                    <div class="panel-google-plus-textarea">
                        <textarea rows="4"></textarea>
                        <button type="submit" class="btn btn-success btn-xs disabled">Post comment</button>
